...
#
# File name: DrawingGeometry.py
#
# Program Description: The following program uses user input to create shapes using turtle

# allows the code to interpret functions from turtle
import turtle

# creates separate sprites for each shape/drawing
...
# the drawRectangle function creates a gray rectangle based on the starting point, width, and height provided
# by the user
